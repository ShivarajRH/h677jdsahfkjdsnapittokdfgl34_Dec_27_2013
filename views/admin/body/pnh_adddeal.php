...
<tr><td>Print Name : </td><td><input type="text" name="print_name"  id="print_name" class="inp" size=50 value="<?=$d?$d['print_name']:""?>"><div class="hint">(If it is empty, deal name will be considered as print name.)</div></td></tr>
<tr><td>Tagline : </td><td><input type="text" name="tagline" class="inp" size=30 value="<?=$d?$d['tagline']:""?>"></td></tr>
<tr><td>Max order qty(per day) : </td><td><input type="text" name="max_allowed_qty" class="inp" size=30 value="<?=$d?$d['max_allowed_qty']:""?>"></td></tr>
...
$(function(){
	...
	$("#pnh_add_d_form").submit(function(){
		...
		if($("#print_name").val()=='') {
                    if(!confirm("Print name is empty you want deal name as print name?")) {
                        $("#print_name").focus();
                        return false;
                    }
                }
