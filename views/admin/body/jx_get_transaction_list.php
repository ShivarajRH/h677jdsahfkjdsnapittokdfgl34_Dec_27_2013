...
//   PAGINATION ENDS
    ...
    $output .= '<div class="trans_pagination pagi_top">'.$trans_pagination.' </div>
        ...
        if($trans_arr['batch_enabled']==1)
            $batch_status_msg='<div class="batch_msg enabled clear"><a href="javascript:void(0);" class="batch_status_msg_'.$trans_arr['transid'].'" onclick="batch_enable_disable(\''.$trans_arr['transid'].'\',0)">Disable for batch</a></div>';
        else {
            $batch_status_msg='<div class="batch_msg disabled clear"><a href="javascript:void(0);" class="batch_status_msg_'.$trans_arr['transid'].'" onclick="batch_enable_disable(\''.$trans_arr['transid'].'\',1)">Enable for batch</a></div>';
