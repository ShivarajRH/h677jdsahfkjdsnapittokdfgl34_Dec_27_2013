		...
		<tr class="bars bar<?=$i['barcode']?> prod_scan">
			...
			<td class="prod"><input type="hidden" class="pid" value="<?=$i['product_id']?>">  
                        ...
                        <td style="vertical-align: middle;" align="center">
                            ...
                            <div class="clear"></div>
                            <span class="trans_status">PENDING</span>
			...
			<td>
                            ...
                            ?>
                                                    <li>
                                                        <span class="imei_inp_txt1">IMEI Number : </span>
					...
					<td style="vertical-align: middle; text-align: center;">
                                            <div class="scan_proditems">
                                                ...
                                                foreach($mrp_list['det'] as $mrp_b)
                                                {
                                                        ...
                                                        ?>
                                                        <input type="hidden" value="0" rb_id="<?php echo $mrp_b[2].'_'.$mrp_b[3]?>" rb_name="<?php echo $mrp_b['rb_name']?>"
                                                ...
                                                ?>
                                                        <input type="button" value="0" mrp="<?php echo $mrp ?>" stk_i="<?php echo $stk_i;?>"
                                                            itemid="<?php echo $i['itemid']?>" 
                                                            p_invno="<?php echo $i['p_invoice_no']?>"
                                                            pid="<?php echo $prd_id;?>"
                    ...
                    <table cellpadding="4" cellspacing="0">
                            ...
                            <tr>
                                    <td valign="top">
                                        ...
                                        foreach($invoice as $i)
                                        {
                                                $trans_id = $this->reservations->get_transid_by_invoice($i['p_invoice_no']);
                                                $user_msg=$this->reservations->get_transactions_note($trans_id);

                                                $note_msg = isset($user_msg['note']) ? "<b>".$trans_id." - ".str_replace('update :','<br>update :',$user_msg['note'])."</b><br>": "";
                                                echo $note_msg;
                                        }
                                        ?>
                                        </div>
...
<script type="text/javascript">
	...
	?>
        ...
        function upd_selprodstk(ele)
        {
                ...
                needed=parseInt($(".qty").html());
                have=parseInt($(".have").html());
                if(needed<=have)
                {
