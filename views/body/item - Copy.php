...
*/ ?>				
				...
				<div class="itempic">
					<div style="width:100%;height:295px;position:relative;overflow:hidden;">
			...
			<div style="float:left;border-right:2px solid #eee;font-size:13px;width:400px;clear:left;padding-right:10px;" align="left">
				<div style="padding-top:10px;font-weight:bold;padding-bottom:5px;font-size:15px;border-bottom:2px solid #ccc;">Description</div>
				...
				<div class="itempricedet">
					...
					*/ ?>
					...
					<table width=100%>
					    <tr>
					        <td width=40%>
					            <div align="center" style="font-size:28px"><b><span style="font-size: 80%">Rs</span> <?=number_format($item['price']).'/-'?></b></div>
					             <div align="center" style="margin:10px;height: 30px;">
					             	<?php 
					             		if($item['price'] != $item['orgprice']){
					             	?>
					                 <strike style="color:#cd0000"><span style="font-size: 80%">Rs</span> <?=number_format($item['orgprice'])?> </strike> 
					                &nbsp;&nbsp;<b><?=ceil(($item['orgprice']-$item['price'])/$item['orgprice']*100)?>% Off</b>
					                <?php } ?>
					            </div>
					         ...
					         <td width=60% valign="top" style="border-left:1px solid #EDD5D5">
					            <div style="padding:10px;text-align: center;" >
									...
									<div class="instantcocont" style="cursor:default;float: none;text-align: center;padding:10px 0px 0px">
<?php if(!$item['live']){?>
										<img src="<?=IMAGES_URL?>/ofs.png">
<?php }else{?>
										<img src="<?php echo IMAGES_URL;?>/instant_checkout.png" onclick="instantco()" style="cursor:pointer;">
<?php }?>
									</div>
...
<?php if(!$item['live']){?>
					...
					<a href="javascript:void(0)" onclick='$("#remindme").show()'><b>Remind me when available</b></a>
					<div id="remindme" style="display:none;">
					<form id="remindmefrm">
						<input type="hidden" name="id" value="<?=$item['id']?>">
						<table cellpadding=5>
						<tr><td>Enter your Email : </td><td><input type="text" name="email" size=30></td></tr>
						<tr><td>Enter your Mobile : </td><td><input type="text" name="mobile" size=20></td></tr>
...
<?php if($deal['orgprice']!=$deal['price']){?>							
							<div class="save"><b>save <?=ceil(($deal['orgprice']-$deal['price'])/$deal['orgprice']*100)?>% OFF</b></div>
